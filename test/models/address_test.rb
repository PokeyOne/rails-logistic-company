...
class AddressTest < ActiveSupport::TestCase
  ...
  test "address one liner with no line two" do
    address = Address.new(line_one: "123 Main St.", line_two: "", city: "Somewhere", country: "USA", region: "CA", postal_code: "90210")
    assert_equal "123 Main St., Somewhere, CA, 90210, USA", address.one_liner
  end

  test "address one liner with line two" do
    address = Address.new(line_one: "123 Main St.", line_two: "Suite 101", city: "Somewhere", country: "USA", region: "CA", postal_code: "90210")
